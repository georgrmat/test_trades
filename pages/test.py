...
df_trades['yield'] = 1 + df_trades['yield_pct']/100
df_trades['yield_fees'] = (1 - fees/100)**2 * df_trades['yield']

df_trades['yield_fees_pct'] = (df_trades['yield_fees'] - 1) * 100


st.line_chart(100000 * df_trades['yield_fees'].cumprod())
